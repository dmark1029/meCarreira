      ...
      `,
        ...
        function render(target) {
          ...
          if (!config.TRANSPARENT) {
            ...
            let bc
            if (k === 3) {
              bc = config.BACK_COLOR_GRAY
            } else if (k === 4) {
              bc = config.BACK_COLOR_GRAY1
            } else {
        ...
        canvasList[k].addEventListener('mousedown', () => {
          ...
          //   pointers[0].color = { r: 0, g: 0.15, b: 0.0056628010708020815 } //generateColor();
          // } else {
          //   pointers[0].color = { r: 0.15, g: 0.06362859243459015, b: 0 } //generateColor();
          // }
