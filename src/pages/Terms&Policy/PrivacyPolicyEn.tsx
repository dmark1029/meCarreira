    ...
    >
      <div className="mt-20 mb-20 policy-container">
        ...
        <Clause title={t('Personal Information')} fontStyle="h-3">
          <div className="terms-content">
            <p className="ct-p1">
              We have various types of personal information that we collect.
              Depending on the type of user you are and experience you are
              seeking, different personal information is collected.
            </p>
            <p className="ct-p1">
              We ask for personal information — when you visit our page — which
              may include one or more of the following:
            </p>
            <ul>
              <li className="ct-p1">IPs (historic)</li>
              <li className="ct-p1">Device Identification</li>
            </ul>
            <p className="ct-p1">
              We may ask for <u>additional</u> personal information — when you
              subscribe to our newsletter or when you contact us — which may
              include one or more of the following:
            </p>
            <ul>
              <li className="ct-p1">Email</li>
              <li className="ct-p1">IP used</li>
              <li className="ct-p1">Device Identification</li>
              <li className="ct-p1">Full Name</li>
              <li className="ct-p1">Country of Residence</li>
            </ul>
            <p className="ct-p1">
              We may ask for <u>additional</u> personal information — when you
              create a user profile — which may include one or more of the
              following:
            </p>
            <ul>
              <li className="ct-p1">Mobile Number </li>
              <li className="ct-p1">Preferred Currency</li>
              <li className="ct-p1">Blockchain Public Key</li>
              <li className="ct-p1">IPs (historic)</li>
              <li className="ct-p1">Device Identification</li>
            </ul>
            <p className="ct-p1">
              We may ask for <u>additional</u> personal information — when you
              create a player profile — which may include one or more of the
              following:
            </p>
            <ul>
              <li className="ct-p1">Email</li>
              ...
              <li className="ct-p1">Device Identification</li>
              <li className="ct-p1">Mobile Number </li>
              <li className="ct-p1">Passport Copy (graphical)</li>
              <li className="ct-p1">Full Name</li>
              <li className="ct-p1">Date of Birth</li>
              <li className="ct-p1">Nationality</li>
              <li className="ct-p1">Public Instagram Link</li>
              <li className="ct-p1">Public Transfermarkt Link</li>
              <li className="ct-p1">Blockchain Public Key</li>
            </ul>
          </div>
        </Clause>
        ...
        <Clause title={t('Collection and Use of Information')} fontStyle="h-3">
          <div className="terms-content">
            ...
            <ul>
              <li className="ct-p1">Visit our Website</li>
              <li className="ct-p1">Register for an account</li>
              <li className="ct-p1">
            ...
            <ul>
              ...
              <li className="ct-p1">
                for tracking purposes e.g. analytics software
              </li>
            </ul>
            <p className="ct-p1">
