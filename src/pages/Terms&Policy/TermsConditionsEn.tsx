  ...
  return (
    ...
    >
      <div className="mt-20 mb-40">
        ...
        <Clause title={t('Protocol Disclaimer')} fontStyle="h-2">
          <div className="terms-content ct-p1">
            Please also read the meCarreira{' '}
            <a href="#" onClick={() => navigate('/disclaimer')}>
              protocol disclaimer
            </a>{' '}
            as it is part of this Terms & Conditions.
          </div>
        </Clause>
        <Clause title={t('Wallet Usage')} fontStyle="h-2">
          <div className="terms-content ct-p1">
            Do only use <a href="https://mecarreira.com">meCarreira.com</a>{' '}
            using your own blockchain wallet (polygon wallet) and do not use a
            smart contract to issue transactions as this can result in loss of
            funds. If you use meCarreira with any smart contract, you might
            incur losses due to security mechanisms that prevent abuse.
          </div>
        </Clause>
      </div>
    </div>
